...
#define LEVEL1_Right_EDGE 5.0f
#define LEVEL1_TOP_EDGE 5.0f
...
void update()
{
    ...
    if (g_current_scene == g_level_a && (g_level_a->get_survive_level() == true)) {
     switch_to_scene(g_levels[2]);
    }

    if (g_current_scene == g_level_b && (g_level_b->get_survive_level() == true)) {
